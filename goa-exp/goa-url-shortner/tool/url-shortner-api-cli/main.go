...
import (
	...
	"github.com/nikhil-thomas/technik-dojo/goa-exp/goa-url-shortner/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "URL shortner API-cli",
		Short: `CLI client for the URL shortner API service`,
	}
	...
	c.UserAgent = "URL shortner API-cli/0"
