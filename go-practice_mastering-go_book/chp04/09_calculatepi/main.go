...
// the goal for this example to explore math/big pacakge
...
func pi(accuracy uint) *big.Float {
	...
	twoPowSix := math.Pow(2, 6)
	twoPowSixBig := new(big.Float).SetPrec(precision).SetFloat64(twoPowSix)
