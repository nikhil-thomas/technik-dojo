...
import (
	...
	"github.com/nikhil-thomas/technik-dojo/cloud-native-programming-with-golang/chp04/src/contracts"
)
...
func (e *StaticEventMapper) MapEvent(eventName string, serialized interface{}) (Event, error) {
	...
	default:
		...
		if err != nil {
			return nil, fmt.Errorf("could not initialize decoder %s: %s", eventName, err)
		}
